...
<form action="/Mac_Facility/UserController?save_mar_details" method="post">
			<table style="with: 50%">
			<tr>
					<td>Facility Type(*):</td>
					<td>
				...
				<tr>
					<td>Time(*):</td>
					<td><input type="time" name="date" value = "HH:MM"/></td>
				</tr>
				

				</table>
  			<input name="action" value="save_mar_details" type="hidden">
